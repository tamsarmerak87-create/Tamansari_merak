...
export function FloatingActions() {
    return (
        <div className="fixed bottom-5 right-4 z-50 flex flex-col gap-3 sm:right-5">
            ...
            <Link className="grid size-12 place-items-center rounded-full bg-accent-400 text-gov-950 shadow-glass transition hover:-translate-y-1" href="/#chat" aria-label="TAMSAR CS">
                <Headset size={20} />
            </Link>
