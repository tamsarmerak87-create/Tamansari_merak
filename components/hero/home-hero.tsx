        ...
        <section className="relative px-4 pb-12 pt-6 sm:px-6 sm:pb-16 sm:pt-8 lg:px-8 lg:pt-10">
            ...
            <div className="mx-auto grid max-w-7xl items-start gap-8 lg:grid-cols-[.92fr_1.08fr] xl:gap-12">
                <MotionShell className="relative z-10 pt-4 lg:pt-0 lg:self-start">
                    ...
                    <h1 className="mt-5 max-w-[760px] text-balance font-black leading-tight tracking-tight text-gov-950 [font-size:clamp(2.25rem,5.2vw,5.9rem)] sm:[font-size:clamp(3rem,5vw,5.9rem)] lg:[font-size:clamp(4rem,5.2vw,5.9rem)]">
                    ...
                    <p className="mt-5 w-full max-w-[640px] text-base font-semibold leading-[1.7] text-gov-900/76 sm:text-lg">
                ...
                <MotionShell delay={0.12} className="relative aspect-[4/3] w-full self-start sm:aspect-[5/4] lg:aspect-[5/4] lg:mt-2 lg:w-[55%] lg:justify-self-end">
                    ...
                    <div className="relative h-full overflow-hidden rounded-[1.5rem] border border-white bg-white shadow-[0_28px_80px_rgba(15,39,72,.22)] ring-1 ring-border-soft/80 sm:rounded-[2rem] lg:rounded-[2.4rem] lg:border-[10px]">
                        <Image
                        ...
                        <div className="absolute bottom-4 left-4 right-4 max-w-md rounded-[24px] border border-white/15 bg-gov-800/94 p-4 text-white shadow-glass backdrop-blur-2xl sm:bottom-6 sm:left-auto sm:right-6 sm:p-6">
